...
package nie.translator.MLTranslator.tools.gui.peers.array;

import android.content.Context;
import androidx.annotation.NonNull;
import java.util.Collection;
import nie.translator.MLTranslator.R;
import nie.translator.MLTranslator.tools.gui.WeightArray;
import nie.translator.MLTranslator.tools.gui.WeightElement;
import nie.translator.MLTranslator.tools.gui.peers.GuiPeer;
import nie.translator.MLTranslator.tools.gui.peers.Header;
