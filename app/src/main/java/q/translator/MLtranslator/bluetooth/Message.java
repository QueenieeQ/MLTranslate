...
public class Message implements Parcelable, Cloneable {
     ...
     */
    public ArrayDeque<nie.translator.MLTranslator.bluetooth.BluetoothMessage> splitInBluetoothMessages(nie.translator.MLTranslator.bluetooth.BluetoothMessage.SequenceNumber id) {
        int subDataLength = nie.translator.MLTranslator.bluetooth.BluetoothConnection.SUB_MESSAGES_LENGTH - nie.translator.MLTranslator.bluetooth.BluetoothMessage.TOTAL_LENGTH;
        ...
        nie.translator.MLTranslator.bluetooth.BluetoothMessage.SequenceNumber sequenceNumber = new nie.translator.MLTranslator.bluetooth.BluetoothMessage.SequenceNumber(context, nie.translator.MLTranslator.bluetooth.BluetoothMessage.SEQUENCE_NUMBER_LENGTH);
        ArrayDeque<nie.translator.MLTranslator.bluetooth.BluetoothMessage> bluetoothMessages = new ArrayDeque<>();
        while (subDataArray.peekFirst() != null) {
            byte[] subData = subDataArray.pollFirst();
            int type;
            if (subDataArray.peekFirst() == null) {
                type = nie.translator.MLTranslator.bluetooth.BluetoothMessage.FINAL;
            } else {
                type = nie.translator.MLTranslator.bluetooth.BluetoothMessage.NON_FINAL;
            }
            bluetoothMessages.addLast(new nie.translator.MLTranslator.bluetooth.BluetoothMessage(context, id.clone(), sequenceNumber.clone(), type, subData));
